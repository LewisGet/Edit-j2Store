...
$action = JRoute::_('index.php?option=com_j2store&view=layouts');
...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_j2store&task=layouts.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'layoutList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<?php echo JText::_('J2STORE_PRODUCT_LAYOUT_HELP_TEXT'); ?>
</div>
...
<form action="<?php echo $action;?>" name="adminForm" class="adminForm" id="adminForm" method="post">
	 ...
	 <table class="adminlist table table-striped" id="layoutList">
			<thead>
				...
				<th class="name">
					<?php echo JHtml::_('grid.sort',  'J2STORE_PAO_NAME', 'a.store_name', $listDirn, $listOrder); ?>
				</th>
				<th width="5%">
		...
		<tbody>
				...
				<tr class="row<?php echo $i%2; ?>" sortable-group-id="1">
					<td class="order nowrap center hidden-phone"><?php if ($canChange) :
						...
						<td><?php echo JHtml::_('grid.id',$i,$item->layout_id); ?> </td>
						<td>
							 <a href="<?php echo 'index.php?option=com_j2store&view=layout&task=layout.edit&layout_id='.$item->layout_id; ?>">
								<?php echo $item->layout_name;?>
							</a>
						</td>
						<td class="center"><?php echo JHtml::_('jgrid.published', $item->state, $i, 'layouts.', $canChange, 'cb'); ?></td>
			</tr>
			<?php endforeach;?>
		<?php endif;?>
