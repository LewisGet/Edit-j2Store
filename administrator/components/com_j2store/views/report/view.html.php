...
class J2StoreViewReport extends J2StoreView
{
	...
	protected function addToolbar()
	{
		...
		if($app->input->get('reportTask')){
			JToolBarHelper::back('J2STORE_BACK_TO_REPORT', 'index.php?option=com_j2store&view=report&task=view&id='.$app->input->getInt('id')  );
	 		JToolBarHelper::custom('view', '', '', 'J2STORE_EXPORT_ORDERS', false);
		}
	}
}
