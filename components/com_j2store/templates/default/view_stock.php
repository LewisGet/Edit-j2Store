...
$instock_text = JText::_($this->layout_params->get('product_instock_alternative_text', 'J2STORE_IN_STOCK')) ;
?>

<?php if($this->layout_params->get('show_product_option_stock', 0) && J2STORE_PRO==1 && isset($this->item->option_stock) && $this->item->manage_stock == 1):?>
...
<?php if($this->layout_params->get('show_product_stock', 0) && J2STORE_PRO==1 && $this->item->manage_stock == 1):?>
				<div class="j2store-product-stock" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
				<?php if($this->item->inventory->can_allow):?>
					...
					<?php elseif($this->item->inventory->backorder && $this->item->inventory->can_allow == 0):?>
							<?php echo JText::_('J2STORE_ADDTOCART_BACKORDER_ALERT'); ?>
					<?php else: ?>
						<span><link itemprop="availability" href="http://schema.org/OutOfStock" /><?php echo JText::_( "J2STORE_OUT_OF_STOCK" ); ?></span>
					<?php endif; ?>
